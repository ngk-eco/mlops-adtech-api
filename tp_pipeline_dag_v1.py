...
# --------------------------------------
DB_HOST = "mlops-tp-db.cf4i6e6cwv74.us-east-1.rds.amazonaws.com"  # tu endpoint
DB_PORT = 5432
DB_NAME = "postgres"                   # usamos la DB 'postgres' por simplicidad
DB_USER = "grupo_6_2025"
DB_PASSWORD = "NubeMLOPS!"       # poné la misma que usaste con psql
...
def filtrar_datos():
    ...
    # 2) Igual que antes: leer y filtrar
...
def calcular_top_product():
    ...
    Guarda el resultado en top_product.csv.
    """
...
def calcular_top_ctr():
    ...
    Guarda el resultado en top_ctr.csv.
    """
...
def db_writing(**context):
    ...
    # 1) Leer los CSV generados por las tasks anteriores
